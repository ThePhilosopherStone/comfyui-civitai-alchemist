...
async function downloadModel(resource) {
...
async function downloadAllMissing(resources) {
  const missing = resources.filter((r2) => r2.resolved && !r2.already_downloaded);
        ...
        createBaseVNode("div", _hoisted_1$2, [
          ...
          createBaseVNode("span", _hoisted_4$2, [
            ...
            formattedSize.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              createBaseVNode("span", _hoisted_6$2, toDisplayString(formattedSize.value), 1)
...
const ModelCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9b8dc5c9"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const downloadableCount = computed(
      () => props.resources.filter((r2) => r2.resolved && !r2.already_downloaded && (!r2.downloadStatus || r2.downloadStatus === "idle" || r2.downloadStatus === "failed" || r2.downloadStatus === "cancelled")).length
    );
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        downloadableCount.value > 0 || __props.batchDownloading ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
          !__props.batchDownloading ? (openBlock(), createElementBlock("button", {
            key: 0,
            class: "batch-btn download-all-btn",
            onClick: _cache[3] || (_cache[3] = ($event) => _ctx.$emit("download-all"))
          }, " Download All Missing ")) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            createBaseVNode("button", _hoisted_7$1, " Downloading... (" + toDisplayString(__props.batchProgress) + "/" + toDisplayString(__props.batchTotal) + ") ", 1),
            createBaseVNode("button", {
              class: "batch-btn cancel-all-btn",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const batchDownloading = /* @__PURE__ */ ref(false);
    ...
    function onDownloadProgress(event) {
      ...
      switch (status) {
        ...
        case "verifying":
          ...
          break;
        case "completed":
          resource.downloadStatus = void 0;
          resource.downloadProgress = void 0;
          resource.downloadedBytes = void 0;
          resource.totalBytes = void 0;
          resource.downloadError = void 0;
          resource.taskId = void 0;
      ...
      if (batchDownloading.value && task_id === batchTaskId.value) {
        const batchResources = resources.value.filter(
          (r2) => r2.downloadStatus === "downloading" || r2.downloadStatus === "verifying" || r2.downloadStatus === "waiting"
        );
    ...
    async function handleDownload(resource) {
      ...
      try {
        ...
        resource.downloadStatus = "failed";
        resource.downloadError = e2.message;
      }
    }
    async function handleDownloadAll() {
      const missing = resources.value.filter((r2) => r2.resolved && !r2.already_downloaded);
      if (missing.length === 0) return;
      for (const r2 of missing) {
        r2.downloadStatus = "waiting";
        r2.downloadError = void 0;
      }
    ...
    async function handleCancel(resource) {
      if (resource.taskId) {
        try {
